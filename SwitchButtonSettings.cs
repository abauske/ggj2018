...
public class SwitchButtonSettings : MonoBehaviour {
	...
	public void switchPannels(bool b)
    {
        if(b)
        {
            GameObject.FindGameObjectWithTag("UpgradesPanel").GetComponent<RectTransform>().localPosition = new Vector3( -1650 , 0 , 0);
        ...
        else
        {
            ...
            GameObject.FindGameObjectWithTag("GameSettingPanel").GetComponent<RectTransform>().localPosition = new Vector3(1650, 0, 0);
